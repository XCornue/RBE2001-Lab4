...
void moveUntilLine(LeftMotor motorLeft, RightMotor motorRight);
...
void lineCorrect(LeftMotor motorLeft, RightMotor motorRight);
bool turnLeftHelper();
...
void updateStateMachine(LeftMotor motorLeft, RightMotor motorRight);